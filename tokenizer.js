...
function addSem (sem) {
	...
	comment: function (_1, _2s, _3) { return `[comment ${encodeURIComponent (_2s.token ().join (''))} line[${line}] pos[${offset}]]`; },
	string: function (_1, _2, _3) { return `[string ${encodeURIComponent (_2s.token ().join (''))} line[${line}] pos[${offset}][`; },
	whiteSpace: function (_1) { return `[whiteSpace ${_1.token ()} line[${line}] pos[${offset}]`; },
	symbol: function (_1, _2s) { return `[symbol ${encodeURIComponent (_1.token ())}${encodeURIComponent (_2s.token ().join (''))} line[${line}] pos[${offset}]]`; },
	integer : function (_1) { return `[symbol ${encodeURIComponent (_1.token ())} line[${line}] pos[${offset}]]`; },
	character: function (_1) { return `[character ${encodeURIComponent (_1.token ())} line[${line}] pos[${offset}]]`; },
